          ...
          <div className={Style.NavBar_box_right_menu}>
            {menuItems.map((el, i) => (
              <div onClick={() => setActive(i + 1)} key={i + 1}
                className={`${Style.NavBar_box_right_menu_items} ${active === i + 1 ? Style.active_btn : ""}`}>
                <Link href={el.link}>
                  <a className={Style.NavBar_box_right_menu_items_link}>
                    {el.menu}
                  </a>
                </Link>
              </div>
            ...
            <div className={Style.mobile_menu}>
              {menuItems.map((el, i) => (
                <div onClick={() => setActive(i + 1)} key={i + 1}
                  ...
                  <Link href={el.link}>
                    <a className={Style.mobile_menu_items_link}>
                      {el.menu}
                    </a>
                  </Link>
                </div>
      ...
      {openModel && (
        <div className={Style.modelBox}>
          <Model 
            ...
            title="WELCOME TO"
            head="CIPHER CHAT"
            info="Experience secure and decentralized communication with our Blockchain-based Chat Application Cipher Chat. 
                  Utilizing Blockchain Technology which ensures privacy, immutability, and transparency in messaging."
